...
int sdl_loop(MainComponent &tests)
{
    SDL_Event event;
...
int main(int argc, char *argv[])
{
    ...
    tests.infoDisplay.active = true;
    tests.infoDisplay.watermark = true;
    tests.infoDisplay.resolution = true;
    tests.infoDisplay.fpsinfo = true;
